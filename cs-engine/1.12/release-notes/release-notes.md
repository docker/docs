...
* Fixes an issue where encrypted overlay networks stop working [#30727](https://github.com/moby/moby/issues/30727)
...
* [#28406](https://github.com/moby/moby/issues/28406) Fix conflicts introduced
by the updated `selinux-policy` base package from RHEL/CentOS 7.3
* [#26639](https://github.com/moby/moby/issues/26639) Resolves hostnames passed
to the local volume driver for nfs mount options.
* [26111](https://github.com/moby/moby/issues/26111) Fix issue with adding
...
Refer to the [detailed list](https://github.com/moby/moby/releases/tag/v1.12.6) of all
changes since the release of CS Engine 1.12.5-cs5.

## CS Engine 1.12.5-cs5
(21 Dec 2016)

Refer to the [detailed list](https://github.com/moby/moby/releases/tag/v1.12.5) of all
...
* [#27370](https://github.com/moby/moby/issues/27370) Fix `--net-alias` for
`--attachable` networks
* [#28051](https://github.com/moby/moby/issues/28051) Fix an issue removing
a `--attachable` network by ID.

## CS Engine 1.12.3-cs3
(27 Oct 2016)

Refer to the [detailed list](https://github.com/moby/moby/releases) of all
...
* [#25962](https://github.com/moby/moby/pull/25962) Allow normal containers
...
[#19728](https://github.com/moby/moby/issues/19728)
* Fix race in libdevicemapper symlink handling
[#24671](https://github.com/moby/moby/issues/24671)
* Generate additional logging when unmarshalling devicemapper metadata
[#23974](https://github.com/moby/moby/pull/23974)
...
[#21933](https://github.com/moby/moby/issues/21933)
...
https://github.com/moby/moby/issues/22486
