...
* Test SSO using your domain email address and IdP password to successfully sign in and sign out of Docker Hub
...
To configure SSO, we support **SAML** connections with most **Azure AD** IdPs as well as **Azure AD Open ID Connect (OIDC)**.
...
2. To authenticate through the CLI, your users must have a PAT before you enforce SSO for CLI users.
...
You don’t need to manually add users to your organization in Docker Hub. You just need to make sure an account for your users exists in your IdP. They will be added to the organization once they sign in to Docker Hub.
...
> **Note:**
>
> when you remove a member from an SSO organization, they are unable to sign
