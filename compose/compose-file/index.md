...
By default, Compose implementations provide external connectivity to networks. `internal` when set to `true` creates an internally-isolated network that cannot be accessed externally.
