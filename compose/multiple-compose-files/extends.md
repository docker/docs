...
`extends` is useful if you only need a single service to be shared, and you know about its internal details so you can to tweak the configuration. But this isn’t an acceptable solution when you want to reuse someone else's configuration as a “black box” and don’t know about its own dependencies.
