...
# Engine stable
ENGINE_SVN_BRANCH="branches/18.04"
ENGINE_BRANCH="18.04"
...
wget -O ${SOURCE}/engine/api/v1.37/swagger.yaml https://raw.githubusercontent.com/docker/docker-ce/18.04/components/engine/api/swagger.yaml || (echo "Failed 1.37 swagger download or the 1.37 directory doesn't exist" && exit -1)
