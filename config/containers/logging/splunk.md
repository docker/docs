...
| `splunk-index-acknowledgment` | optional | Set the correct header needed if index verification is enabled for the given index on the HTTP Event Collector. Defaults to false.                                                                                                                                                                                                          |
