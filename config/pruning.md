...
The `docker images prune` command allows you to clean up unused images. By
default, `docker images prune` only cleans up _dangling_ images. A dangling image
...
[`docker images prune` reference](/engine/reference/commandline/image_prune.md)
for more examples.
