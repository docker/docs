...
We did not specify a port when running the flask application in the container and the default is 5000. If we want our prevrious request going to port 8000 to work we can map the host's port 8000 to the container's port 5000:
