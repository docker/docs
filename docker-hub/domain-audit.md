...
Before you audit your domains, the following prerequisites are required:
   ...
   * You must add and verify your domains. To add and verify a domain, see [Domain control](../single-sign-on/configure/index.md#step-on-add-and-verify-your-domain).
