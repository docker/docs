...
-  You are familiar with Docker terminology. If you discover any unfamiliar terms, see the [glossary](/glossary/#docker){: target="_blank" rel="noopener" class="_"} or [FAQs](../docker-hub/onboarding-faqs.md){: target="_blank" rel="noopener" class="_"}.
