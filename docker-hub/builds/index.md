...
are running, any additional builds goes into a queue to be run later.

The maximum number of pending builds in the queue is 30 and discards further
...
You can add builds to existing repositories, or added when you create a repository.
