...
description: Run certification tests against your logging plugins
keywords: Docker Hub, certified content, logging
redirect_from:
...
6.  Get the product ID from the plan page you'd like to reference for the certification test. Make sure the checkbox is checked and the plan is saved first.
    ...
    Options:
      ...
      -product-id string
        	 Optional Product identifier from Docker Hub for this plugin. Please include it when you want the output sent to docker store for certification.
      -test-script string
