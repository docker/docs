...
description: Frequently asked questions by Docker Hub customers
keywords: Docker Hub, customers
redirect_from:
...
### How do I log in to the Docker Hub?

Log in to the Docker Hub using your free Docker ID. Don’t have a Docker ID
yet? See [Create a Docker Hub account](../accounts/).

You should do `docker login` ( *not `docker login store.docker.com`* )  to login
successfully, and pull content you might be entitled to.
...
### Why do I see the pull command for some products but not others?
