...
keywords: Docker Hub, webhooks, builds
redirect_from:
- /docker-hub/webhooks/
---
...
Webhook is a POST request sent to a defined URL which provides the service.
Docker Hub webhooks fire when an image is built in, or a new tag is added to,
your automated build repository.
