...
4. Enter the Docker IDs or email addresses that you want to invite, up to a maximum of 1000. After each entry, press `Enter`to enter a new entry, or copy and paste multiple entries that are separated by a comma, space, or newline.
