...
func (d *Driver) Create(id string, parent string) (retErr error) {
	id = excludeOverlayIncompatibleChars(id)
	parent = excludeOverlayIncompatibleChars(parent)
	dir := d.dir(id)
...
// excludeOverlayIncompatibleChars makes sure the string can be used as a path
// component in overlay. overlay uses `:` as a path separator in the mount(2)
// options so these characters can't be used in the graph folder structure.
func excludeOverlayIncompatibleChars(in string) string {
