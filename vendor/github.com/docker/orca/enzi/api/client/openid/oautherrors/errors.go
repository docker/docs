...
// ErrorResponse includes the fields of a standard Oauth error response: an error
// code and description.
type ErrorResponse struct {
	Code        string `json:"error,omitempty"             description:"The error code"`
...
func oauthError(errorCode string, err error) *ErrorResponse {
...
func InvalidRequest(err error) *ErrorResponse {
...
func InvalidClient(err error) *ErrorResponse {
...
// description.
func InvalidGrant(err error) *ErrorResponse {
...
func UnauthorizedClient(err error) *ErrorResponse {
...
// the description.
func UnsupportedGrantType(err error) *ErrorResponse {
