  ...
  $.getJSON("https://docs.docker.com/js/archives.json", function(result){
    ...
    $.each(result, function(i, field){
      ...
      if ( field.current && buttonCode == null ) {
        // Get the button code
        buttonCode = '<button id="archive-menu" data-toggle="dropdown" class="btn dropdown-toggle" style="border: 1px solid #82949E; background-color: #fff; color: #FBFBFC;">' + prettyName + '&nbsp;(current) &nbsp;<span class="caret"></span></button>';
