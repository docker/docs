...
// An OpenIDConfig object is used as a response for system OpenID
// configuration.
...
// MakeOpenIDConfig returns an OpenIDConfig response object for the given
// config.
func MakeOpenIDConfig(openIDConfig *config.OpenID) OpenIDConfig {
	return OpenIDConfig{
		IssuerIdentifier: openIDConfig.IssuerIdentifier,
	}
}
