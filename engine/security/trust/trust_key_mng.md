...
the repositories in question. The loss of a root key is not recoverable.  
If you lose a key, send an email to [Docker Hub Support](mailto:hub-support@docker.com).
{:.warning}
