...
keywords: examples, plugins, docker
...
[Nimble Storage plugin](https://infosight.nimblestorage.com/InfoSight/app#software/Integration+Kits/Linux+Toolkit+%28NLT%29) | A volume plug-in that integrates with Nimble Storage Unified Flash Fabric arrays. The plug-in exposes array volume capabilities to the Docker administrator to allow provisioning multi-tenant volumes and clones.
