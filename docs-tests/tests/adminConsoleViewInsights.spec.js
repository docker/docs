// This test verifies https://docs.docker.com/admin/organization/insights/#view-insights-for-organization-users
...
test("adminConsoleViewInsights", async ({ page }) => {
  ...
  await page
    ...
    .getByTestId("insight-dashboard-link")
    .click();
});
