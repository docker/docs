// This test verifies https://docs.docker.com/admin/organization/members/#export-members-csv-file
...
test("adminConsoleExportMembersCSV", async ({ page }) => {
  ...
  await expect(page.getByLabel("Export members")).toBeVisible();
});
