// This test verifies https://docs.docker.com/security/for-admins/domain-audit/
...
test("dockerHubSSOAuditDomains", async ({ page }) => {
  // Go to Docker Hub
  await page.goto("https://app-stage.docker.com/");
  ...
  // Verify Domain audit section exists
  await expect(page2.getByText("Domain AuditVerified domains")).toBeVisible();
});
