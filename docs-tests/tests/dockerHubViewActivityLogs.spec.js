// This test verifies https://docs.docker.com/admin/organization/activity-logs/#view-the-activity-logs
...
test("dockerHubViewActivityLogs", async ({ page }) => {
  // Go to Docker Hub
  await page.goto("https://app-stage.docker.com/");
  ...
  await page2
    .getByTestId("layout-sidebar")
    .getByTestId("org-page-tab-activity")
    .click();
});
