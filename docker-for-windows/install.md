...
### System Requirements
  ...
  - Windows 10 64-bit: Pro, Enterprise, or Education (Build 16299 or later). (For Windows 10 Home, see [Install Docker Desktop on Windows Home](/install-windows-home.md)).
