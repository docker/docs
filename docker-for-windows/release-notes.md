...
In the list below, release notes for stable releases start with "_Docker for Windows.._" and are further identified with **(stable)** after the topic title. You can download and run _stable_ and _beta_ product installers at [Download Docker for Windows](index.md#download-docker-for-windows).
...
## Docker for Windows 1.12.0 (2016-07-28 1.12.0-beta21) (stable)
...
* Docker 1.12.5 RC5 with experimental features

**Bug fixes and minor changes**

* Fixed networking issue when transmitting data to a container via an exposed port.
* Include the sources for qemu-img
* Fix the migration from toolbox when the user has a space in its login
