...
title: Get started with Docker Desktop for Windows
---
...
From Docker Desktop for Windows 18.02 CE Edge and 18.06 CE Stable, a standalone Kubernetes server that runs on your Windows host is included, so that you can test deploying your
...
Select **Docker Store** from the Docker Desktop for Windows menu to access the [Docker store](https://store.docker.com/) website. From there, you can log on to Docker Store and download apps.
...
Select **Sign in /Create Docker ID** from the Docker Desktop for  Windows menu to access your [Docker Cloud](https://cloud.docker.com/){: target="_blank" clas="_" } account. Once logged in, you can access your Docker Cloud repositories directly from the Docker Desktop for Windows menu.
