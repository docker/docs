...
To open the integrated terminal, hover over your running container select the **Show container actions** menu. From the dropdown menu, select **Open in terminal**.
