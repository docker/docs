...
- **Dev Environments**: You can now create a Dev Environment from your local Git repository. For more information, see [Start a Dev Environment from a local folder](../dev-environments/create-dev-env.md#start-a-dev-environment-from-a-local-folder).
