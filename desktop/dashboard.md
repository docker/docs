...
The **Volumes** view in Docker Dashboard enables you to easily create and delete [volumes](#explore-volumes) and see which ones are being used. If you are a developer subscribed to a Pro or a Team plan, you can also see which container is using a specific volume and explore the files and folders in your volumes.
