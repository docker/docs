...
<div class="component-container">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 block">
        <div class="component">
             <div class="component-icon">
                 <img src="/images/download-docker.svg" alt="Docker Desktop for Mac" width="70" height="70">
             </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 block">
        <div class="component">
            <div class="component-icon">
                 <img src="/images/guides.svg" alt="Docker Desktop for Mac" width="70" height="70">
            </div>
     ...
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 block">
        <div class="component">
            <div class="component-icon">
                <img src="/images/notes.svg" alt="Docker for Linux" width="70" height="70">
            </div>
    ...
    <div class="row">
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 block">
        <div class="component">
            <div class="component-icon">
                 <img src="/images/browse.svg" alt="Docker Desktop for Mac" width="70" height="70">
            </div>
     ...
     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 block">
        <div class="component">
          <div class="component-icon">
                 <img src="/images/resources.svg" alt="Docker Desktop for Mac" width="70" height="70">
          </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4 block">
        <div class="component">
            <div class="component-icon">
                <img src="/images/feedback.svg" alt="Docker Desktop for Windows" width="70" height="70">
            </div>
