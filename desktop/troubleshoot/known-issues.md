...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" data-target="#tab2">For all platforms</a></li>
  <li><a data-toggle="tab" data-target="#tab3">For Mac with Intel chip</a></li>
...
- `ping` from inside a container to the Internet does not work as expected.  To test the network, use `curl` or `wget`. See [docker/for-mac#5322](https://github.com/docker/for-mac/issues/5322#issuecomment-809392861){:target="_blank" rel="noopener" class="_"}.
