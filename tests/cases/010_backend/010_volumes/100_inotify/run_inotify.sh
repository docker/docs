...
# SIGPIPE is ignored in Python shell so piping to head doesn't work, 
# see http://stackoverflow.com/questions/33020759/piping-to-head-results-in-broken-pipe-in-shell-script-called-from-python
ID=$(head -c 8 /dev/urandom | LC_CTYPE=C tr -dc A-Za-z0-9)
