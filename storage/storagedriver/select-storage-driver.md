...
> ***NOTE:***  The `overlay` storage driver is deprecated in Docker Engine - Enterprise 18.09, and will be
> removed in a future release. It is recommended that users of the `overlay` storage driver 
> migrate to `overlay2`.

> ***NOTE:*** The `devicemapper` storage driver is deprecated in Docker Engine 18.09, and will be
> removed in a future release. It is recommended that users of the `overlay` storage driver 
> migrate to `overlay2`.
