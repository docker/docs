...
const sortCountries = (obj) => {
  ...
  map(obj, (country, code) => {
    country.code = code;
    sortable.push(country);
  });
  sortable.sort((country1, country2) => {
    return country1.name < country2.name ? -1 : country1.name > country2.name ? 1 : 0;
  });
  return sortable;
};
...
module.exports = sortCountries(countries);
