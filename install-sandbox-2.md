...
description = "Try Docker Datacenter in a sandbox"
keywords = ["tbd, tbd"]
[menu.main]
parent="mn_ucp"
identifier="ucp_evaluate_sandbox-2"
weight=11
+++
<![end-metadata]-->
...
2. Log in to your DTR instance on `node2` using the `docker login` command and
