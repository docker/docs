...
title: Certify your Docker logging plugins
---
...
This page explains how publishers can successfully test their **Docker logging plugins**. For Docker images, see [Certify your Docker images](certify-images).
...
2.  Configure your Docker Registry credentials by defining environment variables _or_ specifying them as arguments.
    ...
    **Windows powershell**
    ...
    b.  To pass arguments to the **inspectDockerLoggingPlugin** command.

    * **--docker-user**
    * **--docker-password**

    Otherwise the **inspectDockerLoggingPlugin** command prompts for them.

3.  Configure endpoints.

    By default the **inspectDockerLoggingPlugin** command uses the following 2 endpoints for communicating to the Docker Hub Registry:
    ...
    * Registry API Endpoint: **https://registry-1.docker.io**
    ...
    b. Specify them as arguments on the **inspectDockerLoggingPlugin** command. In most cases, you only need the default values.
