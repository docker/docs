...
Now that UCP is installed, you need to license it. In order to use UCP you will require a Docker EE standard or advanced subscription, or you can test the platform with a free trial license.
