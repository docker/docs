...
The following table shows all of the platforms where Docker EE Basic can be run.
Each link in the first column takes you to the installation
instructions for the corresponding platform.
...
> Limitations when used with Docker EE Standard or Advanced (UCP)
>
> IBM Power is not supported as managers or workers.
> Microsoft Windows Server is not supported as a manager. Microsoft Windows Server 1803 is not supported as a worker.
