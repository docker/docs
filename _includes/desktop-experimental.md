On the **Experimental features** tab, you have the option to allow feature flags, which are features that Docker is currently experimenting with. This is switched on by default.
