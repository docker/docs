...
### New features
* **Beta:** Docker Hub now supports [two-factor authentication (2FA)](2fa/_index.md). Enable it in your account settings, under the **[Security](https://hub.docker.com/settings/security)** section.
