...
1. Sign in to [Docker Hub](https://hub.docker.com/) using your [Docker ID](../docker-id/_index.md) or your email address.
...
[Docker subscription (plan)](../subscription/_index.md) and your billing history.
