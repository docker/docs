...
The `-v` option tells Docker to create a volume named `jupyter-data` and mount it in the container at `/home/jovyan/work`. By default, this Jupyter image's root directory is `/home/jovyan` and new notebooks are saved there.
