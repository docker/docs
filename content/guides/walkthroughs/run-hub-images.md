...
3. In **Host port**, specify `8090`.
   ![Specifying host port 8090](images/getting-started-run.webp?w=450&border=true)
4. Select **Run**.
...
![Viewing the Containers tab in Docker Desktop](images/getting-started-view.webp?w=650&border=true)
