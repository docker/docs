...
### Update number of repositories for an active subscription

To add or remove the number of repositories associated with your active subscription, [contact support](https://hub.docker.com/support/contact).
