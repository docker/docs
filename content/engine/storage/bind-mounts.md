...
[Compose reference on volumes](/reference/compose-file/05-services.md#volumes).
and
[Compose reference on volume configuration](/reference/compose-file/05-services.md#volumes).
