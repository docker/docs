...
![Overview of the three components of an extension](./images/extensions-architecture.png){{ $image := $image.Resize "600x400" }}
...
![Backend and frontend communication](./images/extensions-arch-2.png)
...
![Executable and frontend communication](./images/extensions-arch-3.png)
