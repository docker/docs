...
Assuming you've [enforced sign-in](../../../security/for-admins/enforce-sign-in/_index.md) and Settings Management is enabled, add the new proxy configuration to the `admin-settings.json` file. For example:
