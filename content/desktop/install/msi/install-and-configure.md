...
| `PROXYENABLEKERBEROSNTLM` | When set to 1, enables support for Kerberos and NTLM proxy authentication. This is available in Docker Desktop 4.33 and later versions| 0 |
