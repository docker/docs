...
See the [links reference](/reference/compose-file/05-services.md#links) for more information.
...
Overlay networks are always created as `attachable`. You can optionally set the [`attachable`](/reference/compose-file/06-networks.md#attachable) property to `false`.
...
Networks can also be given a [custom name](/reference/compose-file/06-networks.md#name):
...
If you want your containers to join a pre-existing network, use the [`external` option](/reference/compose-file/06-networks.md#external)
```yaml
services:
  # ...
networks:
...
- [Top-level `networks` element](/reference/compose-file/06-networks.md)
- [Service-level `networks` attribute](/reference/compose-file/05-services.md#networks)
