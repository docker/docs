...
Docker subscription or legacy Docker subscription. In addition to current features, Docker maintains a [public
...
The following sections provide an overview of Docker subscription plans, as well as resources for legacy Docker subscriptions.
...
Docker Pro enables individual developers to control more of their
...
their customers. A Docker Pro subscription includes access to all Docker products,
...
licensing for commercial use of Docker products including Docker Desktop,
...
Docker Team also has advanced collaboration and management tools, including
...
Docker products including Docker Desktop, Docker Hub, Docker Scout, Docker
...
- [Image Access
  ...
  which lets administrators control what content developers can access
- [Registry Access
  Management](../security/for-admins/hardened-desktop/registry-access-management.md)
  which lets administrators control what registries developers can access
...
Docker Core, Docker Build Cloud, and Docker Scout subscriptions, as well as what changes to expect when
upgrading to new Docker subscription plans:

![Docker Core subscription diagram](./images/subscription-diagram.webp)

## Legacy Docker Core subscriptions

This section provides an overview of legacy Docker Core subscription plans.
...
> all tools. If you subscribed or renewed your subscriptions before December 10, 2024, your legacy Docker subscriptions still apply to your account until you renew. For more details, see [Announcing Upgraded Docker Plans](https://www.docker.com/blog/november-2024-updated-plans-announcement/).
...
your legacy Docker Scout plan to a new Docker subscription plan, your
