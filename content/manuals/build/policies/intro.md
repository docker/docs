...
If your build fails with a policy violation, enable debug mode to see exactly
what went wrong:
...
This shows the input data for each evaluation and the allow/deny decision. For
complete debugging guidance, see [Debugging](./debugging.md).
