...
- [Additional Docker Business seats](#additional-docker-business-seats): Extra team collaboration capabilities
...
![Docker-Sponsored Open Source badge](../../../images/verified-publisher-badge.png)
...
over the repository can change the repository logo. To manage the repository logo, see
...
Verified publisher images are exempt from standard [Docker Hub rate limits](../../../usage/_index.md),
ensuring developers can pull your images without restrictions. This eliminates
potential barriers to adoption and provides a seamless experience for users of
your content.
...
You can select the time span for which you want to view analytics data. You can
also export the data in either a summary or raw format.
