...
permissions](/manuals/platform/security/roles-and-permissions.md).
...
tokens](/manuals/platform/security/access-tokens/organization-access-tokens.md).
...
> [!NOTE]
> When you invite members, you assign them a role. See [Roles and permissions](/manuals/platform/security/roles-and-permissions.md) for details about the access permissions for each role.
