...
- [Migrate JIT to SCIM](/manuals/platform/security/provisioning/scim/migrate-scim.md) if users were provisioned with Just-in-Time (JIT) before you enabled SCIM.
- [Group mapping](/manuals/platform/security/provisioning/scim/group-mapping.md) to sync identity provider groups with members.
- [Troubleshoot provisioning](/manuals/platform/security/provisioning/troubleshoot-provisioning.md) for SCIM, JIT, and attribute issues.
