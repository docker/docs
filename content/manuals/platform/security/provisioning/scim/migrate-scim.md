...
- [Assign roles](/manuals/platform/security/roles-and-permissions/core-roles.md) to members of your org.
- [Enforce sign in](/manuals/platform/security/authentication/enforce-sign-in.md), if needed.
