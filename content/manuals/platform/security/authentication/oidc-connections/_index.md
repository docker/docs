...
[Organization access tokens (OATs)](/manuals/platform/security/access-tokens/organization-access-tokens.md)
...
- [Create an OIDC connection](/manuals/platform/security/authentication/oidc-connections/create-manage.md)
- [OIDC rulesets and subject claims](/manuals/platform/security/authentication/oidc-connections/rulesets-claims.md)
