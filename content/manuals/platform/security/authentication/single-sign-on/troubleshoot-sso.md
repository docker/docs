...
1. Ensure that the attributes being synced from your IdP match Docker's [supported attributes](/manuals/platform/security/provisioning/scim/provision-scim.md#supported-attributes) for SCIM.
...
Add and verify all domains and subdomains used as UPN by your IdP and associate them with your Docker SSO connection. For details, see [Configure single sign-on](/manuals/platform/security/authentication/single-sign-on/connect.md).
