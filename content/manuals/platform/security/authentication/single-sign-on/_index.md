...
> [security announcement](/manuals/platform/security/security-announcements.md#deprecation-of-password-logins-on-cli-when-sso-enforced).

## Next steps

- Start [configuring SSO](connect.md).
- Read the [FAQs](/manuals/faqs/sso-faqs.md).
- [Troubleshoot](/manuals/platform/security/authentication/single-sign-on/troubleshoot-sso.md) SSO issues.
