...
grid:
  - title: Manage custom roles
    ...
    link: /platform/security/roles-and-permissions/custom-roles/manage/
  - title: Permissions reference
    description: Review every permission you can assign when building a custom role.
    icon: list-bullet
    link: /platform/security/roles-and-permissions/custom-roles/permissions-reference/
---
...
[core roles](/manuals/platform/security/roles-and-permissions/core-roles.md)
instead.
