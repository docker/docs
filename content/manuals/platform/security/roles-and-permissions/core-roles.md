...
[custom roles](/manuals/platform/security/roles-and-permissions/custom-roles/_index.md)
instead.
...
> to use [custom roles](/manuals/platform/security/roles-and-permissions/custom-roles/_index.md).
