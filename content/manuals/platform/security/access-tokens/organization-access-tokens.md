...
> [!WARNING]
>
> Organization access tokens are incompatible with Docker Desktop and Image Access Management. If you use these features, use [personal access tokens](/manuals/platform/security/access-tokens/personal-access-tokens.md) instead.
