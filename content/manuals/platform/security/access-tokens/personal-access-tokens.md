...
> [!NOTE]
>
> For organization-wide automation, consider [organization access tokens](/manuals/platform/security/access-tokens/organization-access-tokens.md) which aren't tied to individual user accounts.
...
- Use [organization access tokens](/manuals/platform/security/access-tokens/organization-access-tokens.md) for organization-wide automation
