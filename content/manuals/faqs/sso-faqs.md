---
description: Frequently asked questions about Docker single sign-on, identity providers, user management, and SSO enforcement
keywords: Docker, Docker Hub, SSO FAQs, single sign-on, identity providers, IdP, SAML, Entra ID, user management, SCIM, JIT, administration, security, SSO enforcement
title: SSO FAQs
linkTitle: SSO
weight: 40
tags: [FAQ]
