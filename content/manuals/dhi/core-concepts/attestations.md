...
you can [view the image variant details](../how-to/explore.md#view-image-variant-details)
in Docker Hub.
...
| DHI Image Sources          | Links to a corresponding source image containing all materials used to build the image, including package source code, git repos, and local files, ensuring compliance with open source license requirements. |
...
type URIs for these attestations, [view the chart details](../how-to/explore.md#view-image-variant-details)
in Docker Hub and select the **Attestations** tab.
