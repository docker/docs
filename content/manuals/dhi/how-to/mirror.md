...
Organization owners, editors, and members with a [custom role](../../platform/security/roles-and-permissions/custom-roles/_index.md)
...
access token (OAT)](../../platform/security/access-tokens/organization-access-tokens.md) with the
...
access token (PAT)](../../platform/security/access-tokens/personal-access-tokens.md) with **Read & Write**
permissions, or an [organization access token
(OAT)](../../platform/security/access-tokens/organization-access-tokens.md) with push access to the
relevant repository.
...
1. Set environment variables for your specific environment. Replace the
   ...
   (OAT)](../../platform/security/access-tokens/organization-access-tokens.md). The OAT must have at
   ...
   (PAT)](../../platform/security/access-tokens/personal-access-tokens.md) that has `read only` access.
