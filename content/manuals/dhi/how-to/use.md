...
>   (OAT)](../../platform/security/access-tokens/organization-access-tokens.md) with your organization
...
(OAT)](../../platform/security/access-tokens/organization-access-tokens.md). OATs are owned by the
...
1. [Generate an organization access
   token](../../platform/security/access-tokens/organization-access-tokens.md) with **Read public
   repositories** scope.
...
(PAT)](../../platform/security/access-tokens/personal-access-tokens.md) or [Organization Access Token
(OAT)](../../platform/security/access-tokens/organization-access-tokens.md). Ensure the token has at
