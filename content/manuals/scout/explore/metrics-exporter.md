...
To create a PAT, follow the steps in [Create an access token](/manuals/platform/security/access-tokens/personal-access-tokens.md).
...
2. [Create a Docker access token](/manuals/platform/security/access-tokens/personal-access-tokens.md)
...
To revoke a PAT, follow the steps in the [Create and manage access tokens](/manuals/platform/security/access-tokens/personal-access-tokens.md).
