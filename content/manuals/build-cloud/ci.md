...
- If you are an organization administrator or have permission to create [organization access tokens (OAT)](/manuals/platform/security/access-tokens/organization-access-tokens.md), use an OAT and set `DOCKER_ACCOUNT` to your Docker Hub organization name.
- If you do not have permission to create OATs or are using a personal account, use a [personal access token (PAT)](/platform/security/access-tokens/personal-access-tokens/) and set `DOCKER_ACCOUNT` to your Docker Hub username.
...
- Create an [organization access token (OAT)](/manuals/platform/security/access-tokens/organization-access-tokens.md). The token must have these permissions:
...
- Create a [personal access token (PAT)](/platform/security/access-tokens/personal-access-tokens/) with the following permissions:
   1. **Read & write** access.
