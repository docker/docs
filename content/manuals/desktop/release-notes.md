...
- A new version of [Docker Sandboxes](/manuals/ai/sandboxes/_index.md) is now available on Docker Desktop for Mac and for Windows (Experimental). It provides a secure, isolated, microVM-based environment for running coding agents.
