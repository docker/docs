...
The **Local** and **Docker Hub** tabs near the top toggles between viewing images in your local image store,
and images in remote Docker Hub repositories that you have access to.

Switching to the **Docker Hub** tab prompts you to sign in to your Docker Hub account, if you're not already signed in.
