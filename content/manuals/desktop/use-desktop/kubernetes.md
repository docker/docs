...
version, it's slower to provision than `kind`, and it's not supported by [Enhanced Container Isolation](/manuals/enterprise/hardened-desktop/enhanced-container-isolation/index.md) (ECI),
...
using the [KubernetesImagesRepository](/manuals/enterprise/hardened-desktop/settings-management/configure-json-file.md#kubernetes) setting as follows.
...
> [!NOTE]
>
> In Docker Desktop versions 4.43 or earlier, when using `KubernetesImagesRepository` and [Enhanced Container Isolation (ECI)](/manuals/enterprise/hardened-desktop/enhanced-container-isolation/_index.md)
> is enabled, add the following images to the [ECI Docker socket mount image list](/manuals/enterprise/hardened-desktop/settings-management/configure-json-file.md#enhanced-container-isolation):
>
