...
keywords:
  swarm, secrets, credentials, sensitive strings, sensitive data, security,
...
To update or roll back secrets, consider adding a version
...
> scaled by using a replicated service, and setting up a MySQL cluster is
