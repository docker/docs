...
{{< release-date date="2024-12-XX" >}} ################## TODO #########################3
...
- Deprecated and removed features, see [Deprecated Features](https://github.com/docker/cli/blob/v27.4.0/docs/deprecated.md).
- Changes to the Engine API, see [API version history](https://github.com/moby/moby/blob/v27.4.0/docs/api/version-history.md).
...
- containerd image store: Fix dockerd failing to fully start with a "context deadline exceeded error" with containerd snapshotter and many builds/images. [moby/moby#48954](https://github.com/moby/moby/pull/48954)
...
- Update Go runtime to 1.22.9. [moby/moby#48832](https://github.com/moby/moby/pull/48832), [docker/cli#5602](https://github.com/docker/cli/pull/5602), [docker/docker-ce-packaging#1100](https://github.com/docker/docker-ce-packaging/pull/1100).
...
- Update BuildKit to [v0.17.2](https://github.com/moby/buildkit/releases/tag/v0.17.2). [moby/moby#48942](https://github.com/moby/moby/pull/48942)
