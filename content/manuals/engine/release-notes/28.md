...
- Update BuildKit to [v0.24.0-rc1](https://github.com/moby/buildkit/releases/tag/v0.24.0-rc1). [moby/moby#50781](https://github.com/moby/moby/pull/50781)
- Update Go runtime to [1.24.6](https://go.dev/doc/devel/release#go1.24.6). [moby/moby#50707](https://github.com/moby/moby/pull/50707), [docker/cli#6278](https://github.com/docker/cli/pull/6278)
...
- Go-SDK: `cli/command`: deprecate the `ErrPromptTerminated`, `DisableInputEcho`, `PromptForInput`, and `PromptForConfirmation` utilities. These utilities were for internal use, are no longer used and will be removed in the next release. [docker/cli#6332](https://github.com/docker/cli/pull/6332)
- Go-SDK: `cli/registry/client`: remove deprecated `RepoNameForReference`. [docker/cli#6258](https://github.com/docker/cli/pull/6258)
...
- Mark legacy links env vars (`DOCKER_KEEP_DEPRECATED_LEGACY_LINKS_ENV_VARS`) as deprecated in v28.4 and set for removal in v30.0. [docker/cli#6309](https://github.com/docker/cli/pull/6309)
...
- !TODO: [28.x backport] Add multierror function to api network. [moby/moby#50742](https://github.com/moby/moby/pull/50742)
- !TODO: [28.x backport] Add separate const for daemon httputils to avoid jsonmessage import. [moby/moby#50581](https://github.com/moby/moby/pull/50581)
- !TODO: [28.x backport] Dockerfile: bump gotest.tools/gotestsum v1.12.3 (for go1.25). [moby/moby#50695](https://github.com/moby/moby/pull/50695)
- !TODO: [28.x backport] Fix download-frozen-image-v2. [moby/moby#50664](https://github.com/moby/moby/pull/50664)
- !TODO: [28.x backport] Move swarm runtime plugin spec to swarm types. [moby/moby#50802](https://github.com/moby/moby/pull/50802)
- !TODO: [28.x backport] add local fork of github.com/docker/docker/builder/remotecontext. [docker/cli#6265](https://github.com/docker/cli/pull/6265)
- !TODO: [28.x backport] api/types/system: move DiskUsage, DiskUsageOptions to api/types/backend. [moby/moby#50545](https://github.com/moby/moby/pull/50545)
- !TODO: [28.x backport] api: swagger: Tweak type of ForceUpdate to uint64. [moby/moby#50714](https://github.com/moby/moby/pull/50714)
- !TODO: [28.x backport] build(deps): bump actions/checkout from 4 to 5. [docker/cli#6307](https://github.com/docker/cli/pull/6307)
- !TODO: [28.x backport] cli/command/image: remove exported RunPull, PullOptions. [docker/cli#6358](https://github.com/docker/cli/pull/6358)
- !TODO: [28.x backport] cli/command/plugin: fix linting issues, and assorted cleanups. [docker/cli#6340](https://github.com/docker/cli/pull/6340)
- !TODO: [28.x backport] cli/command/system: don't use deprecated fields in tests. [docker/cli#6379](https://github.com/docker/cli/pull/6379)
- !TODO: [28.x backport] cli/command: TestRetrieveAuthTokenFromImage: don't decode authconfig. [docker/cli#6310](https://github.com/docker/cli/pull/6310)
- !TODO: [28.x backport] cli/command: fix godoc links and inline resolveAuthConfigFromImage. [docker/cli#6315](https://github.com/docker/cli/pull/6315)
- !TODO: [28.x backport] cli/command: rename vars for consistency and prevent shadowing. [docker/cli#6390](https://github.com/docker/cli/pull/6390)
- !TODO: [28.x backport] cli/connhelper: remove dependency on pkg/process. [docker/cli#6262](https://github.com/docker/cli/pull/6262)
- !TODO: [28.x backport] cli/flags: add "hostVar" to handle --host / -H as a single string. [docker/cli#6289](https://github.com/docker/cli/pull/6289)
- !TODO: [28.x backport] client: remove getDockerOS utility in favor of "Ostype" header. [moby/moby#50737](https://github.com/moby/moby/pull/50737)
- !TODO: [28.x backport] client: use go-winio.DialPipe directly. [moby/moby#50822](https://github.com/moby/moby/pull/50822)
- !TODO: [28.x backport] daemon: Daemon.getInspectData: inline struct-literals. [moby/moby#50821](https://github.com/moby/moby/pull/50821)
- !TODO: [28.x backport] docs fixes and fix flag annotation. [docker/cli#6380](https://github.com/docker/cli/pull/6380)
- !TODO: [28.x backport] docs: fix output example for docker system prune. [docker/cli#6277](https://github.com/docker/cli/pull/6277)
- !TODO: [28.x backport] integration-cli: fix flaky TestRestartStoppedContainer. [moby/moby#50697](https://github.com/moby/moby/pull/50697)
- !TODO: [28.x backport] integration/container: XFAIL flaky TestExecResize on Windows. [moby/moby#50698](https://github.com/moby/moby/pull/50698)
- !TODO: [28.x backport] integration/container: fix flaky TestRemoveContainerWithVolume. [moby/moby#50696](https://github.com/moby/moby/pull/50696)
- !TODO: [28.x backport] integration/system: remove TestEventsBackwardsCompatible, add TestEventsNonBlocking. [moby/moby#50777](https://github.com/moby/moby/pull/50777)
- !TODO: [28.x backport] internal/jsonstream: remove uses of deprecated fields. [docker/cli#6354](https://github.com/docker/cli/pull/6354)
- !TODO: [28.x backport] refactor(cli/compose/loader): extract ParseVolume() to its own package. [docker/cli#6331](https://github.com/docker/cli/pull/6331)
- !TODO: [28.x backport] remove aliases for containerd/errdefs, disallow docker/errdefs. [docker/cli#6272](https://github.com/docker/cli/pull/6272)
- !TODO: [28.x backport] remove, update obsolete tests. [moby/moby#50514](https://github.com/moby/moby/pull/50514)
- !TODO: [28.x backport] update dependencies for buildkit. [moby/moby#50780](https://github.com/moby/moby/pull/50780)
- !TODO: [28.x backport] vendor: dario.cat/mergo v1.0.2. [docker/cli#6384](https://github.com/docker/cli/pull/6384)
- !TODO: [28.x backport] vendor: github.com/docker/go-events v0.0.0-20250114142523-c867878c5e32. [docker/cli#6386](https://github.com/docker/cli/pull/6386)
- !TODO: [28.x backport] vendor: golang.org/x/sync v0.16.0, go.etcd.io/bbolt v1.4.3. [moby/moby#50793](https://github.com/moby/moby/pull/50793)
- !TODO: [28.x backport] vendor: golang.org/x/sync v0.16.0. [docker/cli#6348](https://github.com/docker/cli/pull/6348)
- !TODO: [28.x] add internal fork of docker/docker/registry. [docker/cli#6221](https://github.com/docker/cli/pull/6221)
- !TODO: [28.x] api/types/filters: reimplement ToParamWithVersion. [moby/moby#50562](https://github.com/moby/moby/pull/50562)
- !TODO: [28.x] bump version to v28.4.0-dev. [docker/cli#6394](https://github.com/docker/cli/pull/6394)
- !TODO: [28.x] cli/command/container: TestRunPullTermination: rewrite with streamformatter. [docker/cli#6294](https://github.com/docker/cli/pull/6294)
- !TODO: [28.x] docs: add deprecated `bind-nonrecursive` option for `--mount`. [docker/cli#6308](https://github.com/docker/cli/pull/6308)
- !TODO: [28.x] e2e/testutils: fix incorrect use of PluginConfigInterface. [docker/cli#6333](https://github.com/docker/cli/pull/6333)
- !TODO: [28.x] merge v28.3.3 tag into v28.x. [docker/cli#6264](https://github.com/docker/cli/pull/6264)
- !TODO: [28.x] testutil/fixtures/plugin: makePluginBundle: fix invalid spec. [moby/moby#50820](https://github.com/moby/moby/pull/50820)
- !TODO: [28.x] vendor: github.com/docker/docker 02b4a1a3decc (v28.4.0-dev). [docker/cli#6266](https://github.com/docker/cli/pull/6266)
- !TODO: [28.x] vendor: github.com/docker/docker v28.3.3, github.com/opencontainers/image-spec v1.1.1. [docker/cli#6218](https://github.com/docker/cli/pull/6218)
