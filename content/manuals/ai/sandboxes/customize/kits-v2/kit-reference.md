...
what kits are and how to use them, see [Kits](_index.md).
...
Use `schemaVersion: "2"` for the syntax on this page. Version `"1"` also
remains accepted. See [Kits v3](../kits.md) for the preferred authoring format.
...
[Pass arguments to kits](_index.md#pass-arguments-to-kits) for scoping,
