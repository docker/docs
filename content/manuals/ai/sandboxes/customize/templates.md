...
Dockerfile base and build additional content as part of the kit. Its descriptor
declares the network access, credentials, and lifecycle hooks needed at runtime.
