...
[credential bindings](../security/credentials.md).
...
| `description` | Optional. Shown to the user when approving a [binding](../security/credentials.md).                                                     |
...
[credential binding](../security/credentials.md) `file`
