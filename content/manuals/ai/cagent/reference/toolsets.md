...
| `search_files_content`      | Search file contents (grep-like)              |
| `list_directory`            | List directory contents                       |
| `directory_tree`            | View recursive directory structure            |
| `create_directory`          | Create directories                            |
| `move_file`                 | Move or rename files                          |
| `get_file_info`             | Get file/directory metadata                   |
| `add_allowed_directory`     | Request access to additional directories      |
| `list_allowed_directories`  | Check currently allowed directories           |
| `list_directory_with_sizes` | List directory contents with size information |
...
| Tool    | Capability                                      |
| ------- | ----------------------------------------------- |
| `think` | Record reasoning thoughts without taking action |
...
| Tool           | Capability                        |
| -------------- | --------------------------------- |
| `create_todo`  | Create individual todo items      |
| `create_todos` | Create multiple todos at once     |
| `update_todo`  | Update todo status                |
| `list_todos`   | List all current todos and status |
...
| `search_memory`   | Search memories by content or tags |
...
| Tool    | Capability                              |
| ------- | --------------------------------------- |
| `fetch` | Retrieve content from URLs via HTTP GET |
