...
> [!IMPORTANT]
>
> > If your org is managing settings via [Admin console](manuals/enterprise/security/hardened-desktop/settings-management/configure-admin-console/_index.md), with Docker Desktop version lower than 4.58 you will need to manually delete `admin-settings.json` that has been created in the target folder by the `apply` command before step 2. 
