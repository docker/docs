...
- [Enforce sign-in](/manuals/security/authentication/enforce-sign-in/_index.md). Image Access Management only takes effect when users are signed in to Docker Desktop with organization credentials.
