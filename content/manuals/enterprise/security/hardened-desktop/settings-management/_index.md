...
1. [Configuration profiles](/manuals/platform/security/authentication/enforce-sign-in/methods.md#configuration-profiles-method-mac-only) when used to control proxy settings
...
1. Check that you have [added and verified](/manuals/platform/security/provisioning/domain-management.md#add-and-verify-a-domain) your organization's domain.
2. [Enforce sign-in](/manuals/platform/security/authentication/enforce-sign-in/_index.md) to
