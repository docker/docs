...
1. [Configuration Profiles](/manuals/enterprise/security/enforce-sign-in/methods.md#configuration-profiles-method-mac-only): super-set of Admin Console policies
