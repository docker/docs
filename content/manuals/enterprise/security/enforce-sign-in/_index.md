...
Enforcing Docker Desktop sign-in and [enforcing SSO](/manuals/security/authentication/single-sign-on/connect.md#optional-enforce-sso) are different features that serve different purposes:
