...
Docker OIDC is available for organizations with Docker Core subscriptions. You receive 10 OIDC connections out of the box. To upgrade your subscription, see [Change your subscription](https://docs.docker.com/subscription/change/). 
...
- GitHub provides a JWT ID token with `getIdToken()`.   
