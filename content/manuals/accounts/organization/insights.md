...
- Administrators must [enforce sign-in](/manuals/security/authentication/enforce-sign-in/_index.md)
  for users
...
- Make sure users sign in to an account associated with your
  ...
  sign-in](/manuals/security/authentication/enforce-sign-in/_index.md).
