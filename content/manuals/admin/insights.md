...
- Administrators must [enforce sign-in](/manuals/platform/security/authentication/enforce-sign-in/_index.md)
  for users
...
- Type: User type
- Role: User [role](/manuals/platform/security/roles-and-permissions.md)
...
- Make sure users sign in to an account associated with your
  ...
  sign-in](/manuals/platform/security/authentication/enforce-sign-in/_index.md).
