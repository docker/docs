...
> [!TIP]
> To learn more about product licenses, Docker Core seats, and other Docker add-ons see [Docker plans](/manuals/subscription/plans/),
...
- [Docker plans](/manuals/subscription/plans/) to learn about different add-ons
