...
params:
  image: /assets/images/learning-paths/docker-scout.webp
  skill: Beginner
  time: 10 minutes
  prereq: None
---
...
When container images are not secure, significant risks arise. Around 60% of
organizations have reported experiencing at least one security breach or
vulnerability incident within a year, leading to notable operational
disruptions.[^CSA] These incidents often result in considerable downtime,
with 44% of affected companies facing more than an hour of downtime per event.
The financial impact is also substantial, as the average data breach cost can
reach $4.45 million.[^IBM] This highlights the critical importance of
maintaining robust container security measures.

Docker Scout enhances container security by providing automated vulnerability
detection and remediation, addressing issues of insecure container images, and
...
pipelines, enhancing the security and efficiency of their workflows. Developers
...
You can use Scout registries other than Docker Hub. Integrating Docker Scout
...
### Is it possible to run `docker scout` commands on a Linux system without a Docker Desktop?
