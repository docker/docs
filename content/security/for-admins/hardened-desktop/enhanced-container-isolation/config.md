...
This can be done either via the `admin-settings.json` file, as described in
[Settings Management](../settings-management/json-file-configure.md). For example:
...
> **Tip**
>
> You can now also configure these settings in the [Docker Admin Console](../settings-management/admin-console-configure.md).
{ .tip}
