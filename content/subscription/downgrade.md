...
>
> Some users who bought a Docker Pro subscription after September 25, 2023 may have a different downgrade experience. When these users downgrade a Docker Pro subscription purchased after this date, changes don't apply immediately and access to paid features is available until the next billing cycle. View the **Billing** details for your account to verify.
{ .restricted }
