...
>
> If you subscribed to Docker Pro after September 25, 2023, you may have a different downgrade experience. When you downgrade a Docker Pro subscription purchased after this date, changes don't apply immediately and access to paid features is available until the next billing cycle. View the **Billing** details for your account to verify.
{ .restricted }
