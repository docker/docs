...
{{ if eq (.Get "product") "admin" }}
  ...
  {{ $member_navigation = "Navigate to the user management page for your organization or company. 
    - Organisation: Select your organization in the left navigation drop-down menu, and then select **Members**.
    - Company: Select your organization in the left navigation drop-down menu, and then select **Users**." }}
