...
namespace Docker.Core.Update
{
    ...
    public class Updater : IUpdater
    {
        ...
        private readonly IInstallUpdateWindow _installWindow;

        public Updater(Version version, Channel channel, IFeedDownloader feedDownloader, IInstallUpdateWindow installWindow)
        {
        ...
        public async Task CheckForUpdates(Action startingUpdate, Action upToDate)
        {
            ...
            _installWindow.Open(latestUpdate, startingUpdate);
        ...
        public string GetAppCastEndPoint()
        {
            return _feedDownloader.GetAppCastEndPoint();
        }
    }
}