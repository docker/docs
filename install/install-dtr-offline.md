...
more information, see the [configuration documentation](../configure/config-security.md)
...
See [Docker Trusted Registry Authentication settings](../configure/config-auth.md) for more details.
