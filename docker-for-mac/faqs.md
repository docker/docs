...
Mac fails to start.  [Reset to Factory Defaults](/docker-for-mac/index.md#reset) is the simplest
...
[Add TLS certificates](/docker-for-mac/index.md#add-tls-certificates) in the Getting Started topic.
