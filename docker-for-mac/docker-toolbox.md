...
- [The Docker Toolbox environment](#the-docker-toolbox-environment)
- [The Docker for Mac environment](#the-docker-for-mac-environment)
- [Setting up to run Docker for Mac](#setting-up-to-run-docker-for-mac)
- [Docker Toolbox and Docker for Mac coexistence](#docker-toolbox-and-docker-for-mac-coexistence)
- [Using different versions of Docker tools](#using-different-versions-of-docker-tools)
	- [Checking component versions](#checking-component-versions)
