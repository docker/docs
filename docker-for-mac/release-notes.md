...
- It is again possible to share directories in `~/Library` into a container except Desktop ones. Fixes [docker/for-mac#5115](https://github.com/docker/for-mac/issues/5115).
